...
import numpy as np
from .sage_conv_edge_pool import SageEdge
from .multi_view_conv import MVCNN, SVCNN
...
class WrapperModel(BaseModel):
    ...
    def forward(self, data):
        m_out = self.model1(data[1].to(device='cuda'))[1]   #mvcnn的输出结果
        s_out = self.model2(data)[1]  #sage
